...
def nn_model():
    model = Sequential()
    model.add(Dense(400,W_regularizer=l1l2(l1=0.1,l2=0.1),input_dim=X_train.shape[1],init='he_normal'))
    model.add(PReLU())
    model.add(Dropout(0.3))
    model.add(Dense(200,W_regularizer=l1l2(l1=0.1,l2=0.1),init='he_normal'))
    model.add(PReLU())
